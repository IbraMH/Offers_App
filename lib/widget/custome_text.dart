...
class CustomeText extends StatelessWidget {
  ...
  const CustomeText
      ({Key? key,this.maxLines,this.title,this.overflow, this.weight, this.color = TitleTextSplash, this.fontSize,  this.press,this.fontFamily,this.aligment, this.fontHeight,this.letterSpacing,this.fontWeight=FontWeight.normal,this.textAlign,this.decoration}):super(key:key);
